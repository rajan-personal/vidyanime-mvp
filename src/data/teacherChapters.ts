...
export const teacherChapters: ChapterDetails[] = [
  ...
  videoStreamUrl: getAssetPath("video.mp4"),
    timeline: [
      { label: "Intro", timestamp: 0 },
      { label: "What is Equator?", timestamp: 19 },
      { label: "India location on the Earth", timestamp: 75 },
      { label: "Longitudes and Latitudes", timestamp: 112 },
      { label: "Longitudes and Latitudes of India", timestamp: 204 },
      { label: "Time", timestamp: 279 },
      { label: "Eastward and Westward Movement", timestamp: 357 },
      { label: "Question", timestamp: 380 },
      { label: "India’s Political Division", timestamp: 464 },
      { label: "India’s Neighbours", timestamp: 498 },
    ],
    aiPrompt:
